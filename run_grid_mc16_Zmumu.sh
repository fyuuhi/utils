...
COMMAND="pathena --trf \"Reco_tf.py --outputAODFile %OUT.AOD.pool.root --inputRDOFile %IN\" --inDS ${INPUT_RDO} --outDS ${OUTPUT_AOD} --cmtConfig ${CMTCONFIG} --nFilesPerJob 1 --nEventsPerFile 100 --nEventsPerJob 100 --destSE TOKYO-LCG2_SCRATCHDISK"
